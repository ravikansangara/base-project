...
A minimal CMake-based project to use as a Git playground. This repository is designed for experimenting with Git workflows, GitHub Actions, CI/CD, and C++/CMake-based builds.